...
const TimesheetCalendar = () => {
  ...
  const [markedHalfDays, setMarkedHalfDays] = useState([]);
  const [markedFullDays, setMarkedFullDays] = useState([]);
  ...
  const handleMarkFullDay = () => {
    setSelectedTimes((prev) => ({
      ...prev,
      ...selectedDates.reduce((acc, date) => ({ ...acc, [date]: "08:00" }), {}),
    }));
    handleCloseDialog();
  };
  ...
  const handleMarkHalfDay = () => {
    setSelectedTimes((prev) => ({
      ...prev,
      ...selectedDates.reduce((acc, date) => ({ ...acc, [date]: "04:00" }), {}),
    }));
    handleCloseDialog();
  };
  ...
  const handleMarkAbsent = () => {
    setSelectedTimes((prev) => ({
      ...prev,
      ...selectedDates.reduce((acc, date) => ({ ...acc, [date]: "00:00" }), {}),
    }));
    handleCloseDialog();
  };
    ...
    >
      ...
      <Grid container spacing={1} sx={{ marginTop: 2 }}>
        ...
        {days.map((day, index) => {
          ...
          const isAbsent = selectedTimes[formattedDate] === "00:00";
          const isHalfDay = selectedTimes[formattedDate] === "04:00";
          const isFullDay = selectedTimes[formattedDate] === "08:00";
      ...
      >
        <DialogTitle
          sx={{ bgcolor: grey[200], fontWeight: "bold", textAlign: "center" }}
        >
          Mark Attendance
        </DialogTitle>
        ...
        <DialogContent sx={{ padding: 3 }}>
          ...
          <TextField
            ...
            inputProps={{ min: "04:00", max: "10:00", step: 3600 }}
            sx={{ mt: 2 }}
          />
        </DialogContent>
